...
from metric import getExtrinsic, RteRreEval, calibration_error_batch, eval_mrr, eval_msee
...
parser.add_argument('--dataset', type=str, default="kitti", choices=["kitti", "kd", "kd_corr", "kd_small",
                                                                     "kd_efgh", "nus", "kd_sdeep", "nus_cmr_snr",
                                                                     "kd_cmr_snr",
                                                                     "kd_efgh_snr",
                                                                     "kd_corr_snr_proj",
            ...
            for valid_count, data_valid in tqdm(enumerate(self.test_loader), total=len(self.test_loader)):
                ...
                for i in range(len(cur_x_error)):
                    ...
                    if not DEBUG:
                        ...
                        self.f_result.write(
                            ex2str(init_extrinsic, i) + ex2str(pred_extrinsic, i) +

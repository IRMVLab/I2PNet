...
class ProjectPointNet(nn.Module):
    ...
    def forward(self, xyz_proj_raw, xyz_proj, feature_proj, sample_idx=None,cfg=cfg_default):
        """
        Input:
...
class ProjSetUpconvModule(nn.Module):
    def __init__(self, H, W, out_h, out_w, stride_H, stride_W, kernel_size,
                 nsample, distance, in_channels, mlp,
    ...
    def forward(self, xyz1_raw, xyz2_raw, xyz1, xyz2, idx_n2, feat1, feat2,cfg=cfg_default):
        '''
            Input:

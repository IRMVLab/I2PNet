...
class Evaluator(object):
    def __init__(self):
        ...
        #                      'map-host-a004-lidar0-1233944976297786786-1233945001198600096_0.1_d0.3.pcd')
    ...
    def vis(self):
        ...
        for vis_t in tqdm(range(self.num)):
            ...
            global_im = PointCloudRender(radius=0.015, R=R, T=T, width=w, height=h).rendering(
